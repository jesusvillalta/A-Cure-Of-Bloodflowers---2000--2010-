...
// $Id: calendar.js,v 1.4 2007/01/24 15:44:00 bking Exp $
...
/**
 * I am not sure what the purpose of this function was, but it
 * seems like it may have been written before 'setFulYear'
 * because part of the builtin 'Date' type for Javascript itself,
 * but the problem is obvious, this function causes infinite
 * recursion and thus, stack overflows .. With it commented out,
 * all calls to setFullYear() force the language to use the
 * builtin version of the function, which results in working
 * code in the interface that uses the code in this Javascript
 * file.
 *
